/*
Scoresheet for the Yahtzee game and all methods that interact with the scoresheet.
 */
...
public class ScoreSheet {
    ...
    public void setRow(ROW row, Cup cup){

        ArrayList<Integer> numbers = cup.getCupSortedArray();
    ...
    public boolean checkSmallStraight(ArrayList<Integer> numbers) {
        ...
        numbers = removeUnneededDice(numbers);
    ...
    public ArrayList<Integer> removeUnneededDice(ArrayList<Integer> numbers) {
